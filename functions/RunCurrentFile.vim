...
def g:Run_current_file(): void
    ...
    var interpreters: dict<string> = {python: "python", javascript: (package_json_exists ? "npm run test" : "deno run"), typescript: "deno lint && deno run", html: "start", dosbatch: "call", lua: "lua"}
